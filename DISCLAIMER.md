...
- This repository does not include or redistribute a third-party problem
  database, official solutions, or website screenshots.
- The application includes a visible-page integration module for the current
  page opened by the user. It does not batch collect a problem database,
  access hidden endpoints, intercept network requests, or submit solutions.
...
- The application does not run code or submit solutions on the user's behalf.
